    ...
    */
    ...
    'connections' => [
        ...
        'mongodb' => [
            ...
            //'dsn' => env('DB_URI', 'mongodb+srv://roman_mongodb:pinocho457@cluster0.gv3lsjf.mongodb.net/?appName=Cluster0'),
    ...
    'elasticsearch' => [
        ...
        'hosts' => explode(',', env('ES_HOSTS', 'http://elasticsearch:9200')),
        ...
        'options' => [
            ...
            'auto_create_index' => env('ES_OPT_AUTO_CREATE_INDEX', true),
            ],
        ],
